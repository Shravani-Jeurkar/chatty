from tkinter import *
from myChat import get_responce, bot_name
...
class ChatApplication:
    ...
    def _setup_main_window(self):
        ...
        #head label
        head_label = Label(self.window, bg= BG_COLOR, fg= TEXT_COLOR, text= "Namastey", font= FONT_BOLD, pady= 10)
        ...
        #msg entry box
        self.msg_entry =  Entry(bottom_label, bg='#B3C99C', fg=TEXT_COLOR, font=FONT)
